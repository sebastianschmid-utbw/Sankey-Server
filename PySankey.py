...
Name_KA = 'Ludwigsburg'   # Name muss in Anführungszeichen stehen
EW = 120000               #Anzahl EW
Einheit = 't CO2-eq/Jahr' # Ebenfalls in Anführungszeichen, Einheitliche - Gesamt KA oder Bezug auf EW
Abwasser = 4968620        # [m^3/a]

# Engergie
Energie_BHKW_eigen = 2250897 # [kWh/a]
Energie_fremd = 432362       # [kWh/a]
Energie_gesamt = 2683259     # [kWh/a]
...
CO2eq_Betriebsstoffe = 79             # [t CO2eq/a]
CO2eq_Klaerschlamm_Entsorgung = 730.9 # [t CO2eq/a]
CO2eq_Klaerschlamm_Transport = 7.9    # [t CO2eq/a]
